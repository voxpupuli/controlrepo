...
class profiles::choria (
  ...
  if $broker {
    ...
    nftables::simplerule { 'allow_choria_4_in':
      ...
      proto  => 'tcp',
      dport  => [4222, 4333,],
      saddr  => ['5.75.218.154/32', '95.216.183.49/32', '204.168.136.15/32', '138.199.224.35/32', '194.249.5.47/32', '157.90.132.251/32', '159.69.85.37/32', '95.217.246.117/32', '77.42.36.83/32', "${facts['networking']['ip']}/32",],
    }
    nftables::simplerule { 'allow_choria_6_in':
      action => 'accept',
      proto  => 'tcp',
      dport  => [4222, 4333,],
      saddr  => ['2a01:4f8:1c17:b00c::1/64', '2a01:4f9:c01f:802e::1/64', '2a01:4f9:c013:77c::1/64', '2a01:4f8:c013:b6cb::1/64', '2a01:4f8:252:4667::2/64', '2a01:4f8:c2c:7501::1/64', '2a01:4f9:c01f:9f8a::1/64', '2a01:4f9:c011:bcee::1/64', "${facts['networking']['ip6']}/128",],
    }
